...
//A8C2E8D8_4644_11D6_8118_00B0D08D72FF
		.uuid = &(const struct dsp_uuid) { 0xA8C2E8D8, 0x4644, 0x11D6, 0x81, 0x18,
		{ 0x00, 0xB0, 0xD0, 0x8D, 0x72, 0xFF } },	
//old:
//			.uuid = &(const struct dsp_uuid) { 0x63A3581A, 0x09D7, 0x4AD0, 0x80, 0xB8,
//		{ 0x5F, 0x2C, 0x4D, 0x4D, 0x59, 0xC9 } },

		
	.filename = "720p_h264venc_sn.dll64P",
